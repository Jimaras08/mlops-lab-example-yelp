...
MS_DEPLOYMENT_TEMPLATE_PATH = Path(os.environ["MS_DEPLOYMENT_TEMPLATE_PATH"])
assert MS_DEPLOYMENT_TEMPLATE_PATH.exists(), MS_DEPLOYMENT_TEMPLATE_PATH
MS_DEPLOYMENT_TEMPLATE = Template(MS_DEPLOYMENT_TEMPLATE_PATH.read_text())
