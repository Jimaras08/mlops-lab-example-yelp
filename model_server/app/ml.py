...
from app.constants import MLFLOW_MODEL_CODE_ROOT
...
def load_model(model_artifacts_path: Union[str, Path]):
    ...
    logger.info(f"Adding code dir root to sys.path: {MLFLOW_MODEL_CODE_ROOT}")
    sys.path.append(MLFLOW_MODEL_CODE_ROOT)
